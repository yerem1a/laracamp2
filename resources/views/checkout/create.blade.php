                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="email" type="email" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ Auth::user()->email }}" >
                                @if ($errors->has('email'))
                            ...
                            <div class="mb-4">
                                ...
                                <input name="occupation" type="text" class="form-control {{ $errors->has('occupation') ? 'is-invalid' : '' }}" value="{{ old('occupation') ?: (Auth::check() ? Auth::user()->occupation : '') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="card_number" type="number" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('card_number') ? : '' }}">
